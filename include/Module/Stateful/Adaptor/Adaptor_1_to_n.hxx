...
runtime::Task&
Adaptor_1_to_n::operator[](const adp::tsk t)
{
    return Module::operator[]((size_t)t);
}

runtime::Socket&
Adaptor_1_to_n::operator[](const adp::sck::push_1 s)
{
    return Module::operator[]((size_t)adp::tsk::push_1)[(size_t)s];
}

runtime::Socket&
Adaptor_1_to_n::operator[](const adp::sck::pull_n s)
{
    return Module::operator[]((size_t)adp::tsk::pull_n)[(size_t)s];
}

Adaptor_1_to_n::Adaptor_1_to_n(const size_t n_elmts,
...
Adaptor_1_to_n::Adaptor_1_to_n(const std::vector<size_t>& n_elmts,
