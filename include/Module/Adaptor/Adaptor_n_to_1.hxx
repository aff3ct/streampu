...
runtime::Task&
Adaptor_n_to_1::operator[](const adp::tsk t)
{
    return Module::operator[]((size_t)t);
}

runtime::Socket&
Adaptor_n_to_1::operator[](const adp::sck::push_n s)
{
    return Module::operator[]((size_t)adp::tsk::push_n)[(size_t)s];
}

runtime::Socket&
Adaptor_n_to_1::operator[](const adp::sck::pull_1 s)
{
    return Module::operator[]((size_t)adp::tsk::pull_1)[(size_t)s];
}

Adaptor_n_to_1::Adaptor_n_to_1(const size_t n_elmts,
...
Adaptor_n_to_1::Adaptor_n_to_1(const std::vector<size_t>& n_elmts,
