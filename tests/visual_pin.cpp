...
int main(int argc, char** argv)
{
	...
	// Stateless module to simulate execution time
	module::Stateless pump_module;
	pump_module.set_name("pump");
	auto& task_pump = pump_module.create_task("to_pump");
	auto sock = pump_module.create_socket_out<uint8_t>(task_pump, "out", data_length);

	pump_module.create_codelet(task_pump,
		[sock,data_length](module::Module &m, runtime::Task &t, const size_t frame_id) -> int
	{
