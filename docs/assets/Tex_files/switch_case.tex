...
\newcommand{\legendLight}[1][]{
  \begin{scope}[#1]
    ...
    \node[draw=Paired-1, rounded corners=0pt, minimum height=0.3cm, minimum width=0.7cm, text=Paired-3, thick, densely dashdotted, label={right:Ctrl flow task}] (l4) at (+6.35, 1.4) {};
...
\begin{document}
  \begin{tikzpicture}[background rectangle/.style={thick, draw=gray!60, fill=white, rounded corners=2px}, show background rectangle]
    %%%%%%%%%%%%%%%%%%
    %% create tasks %%
    %%%%%%%%%%%%%%%%%%
    %
