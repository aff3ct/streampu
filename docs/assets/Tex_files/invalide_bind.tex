...
\begin{document}
  \begin{tikzpicture}
    ...
    \task [below=3.0cm of t1]              {t7} {}       {$S_{io}$}          {1} {1}  {0}  {};
    \task [right=1.0cm of t7]              {t8} {}       {$S_{io}$}          {1} {1}  {0}  {};

    \task [right=1.0cm of t8]              {t9} {}       {$S_{io}$}          {1} {1}  {0}  {};
    \task [right=1.0cm of t9]              {t10} {}      {$S_{io}$}          {1} {1}  {0}  {};
    ...
    \draw [bind]                    (t9_so1) --++ (0.25,0.0) --++ (0.0,0.75) --++ (2.25,0.0) --++(0.0,-0.75)|-  (t10_so1);
