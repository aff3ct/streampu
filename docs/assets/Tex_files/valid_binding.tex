...
\begin{document}
  \begin{tikzpicture}
    ...
    %     -------                               --   ------  -----               --- ---- ---- ----------
    \task                                       {t1} {0, 0} {$S_{io}$}           {1} {1}  {0}  {};
    \task [right=1.0cm of t1]                   {t2} {}     {$S_{io}$}           {1} {1}  {0}  {};

    \task [below=1.5cm of t1]                   {t3} {}     {$S_{io}$}           {1} {1}  {0}  {};
    \task [right=1.0cm of t3]                   {t4} {}     {$S_{fwd}$}          {0} {0}  {1}  {};

    \task [right=3.0cm of t1]                   {t5} {}     {$S_{fwd}$}          {0} {0}  {1}  {};
    \task [right=1.0cm of t5]                   {t6} {}     {$S_{io}$}           {1} {1}  {0}  {};

    \task [right=3.0cm of t3]                   {t7} {}     {$S_{fwd}$}          {0} {0}  {1}  {};
    \task [right=1.0cm of t7]                   {t8} {}     {$S_{fwd}$}          {0} {0}  {1}  {};

    \task [right=3.0cm of t5]                   {t9} {}     {$S_{fwd}$}          {0} {0}  {1}  {};
    \task [right=1.0cm of t9, yshift = -0.8cm]  {t10} {}    {$S_{io}$}           {1} {1}  {0}  {};
    \task [right=1.0cm of t9, yshift = 0.8cm]   {t11} {}    {$S_{fwd}$}          {0} {0}  {1}  {};

    \task [below=2.0cm of t9]                   {t12} {}    {$S_{io}$}           {1} {1}  {0}  {};
    \task [right=1.0cm of t12, yshift = -0.8cm] {t13} {}    {$S_{io}$}           {1} {1}  {0}  {};
    \task [right=1.0cm of t12, yshift = 0.8cm]  {t14} {}    {$S_{fwd}$}          {0} {0}  {1}  {};
