...
\begin{document}
  \begin{tikzpicture}[background rectangle/.style={thick, draw=gray!60, fill=white, fill opacity=0.2, rounded corners=2px}, show background rectangle]
    %%%%%%%%%%%%%%%%%%
    %% create tasks %%
    %%%%%%%%%%%%%%%%%%
    ...
    \task [right=1.2cm of t1, yshift=1.15cm] {t2} {}          {increment\\($t_2$)}  {1} {1}  {0}  {};
    \task [below=1.0cm of t2]                {t3} {}          {incrementf\\($t_5$)} {0} {0}  {1}  {};
    \task [right=1.0cm of t2]                {t4} {}          {increment\\($t_3$)}  {1} {1}  {0}  {};
    \task [below=1.0cm of t4]                {t5} {}          {incrementf\\($t_6$)} {0} {0}  {1}  {};
    \task [right=1.0cm of t4]                {t6} {}          {increment\\($t_4$)}  {1} {1}  {0}  {};
    \task [below=1.0cm of t6]                {t7} {}          {incrementf\\($t_7$)} {0} {0}  {1}  {};
    \task [right=1.2cm of t7, yshift=1.2cm]  {t8} {}          {finalize\\($t_8$)}   {2} {0}  {0}  {"seq"};
