...
\begin{document}
  \begin{tikzpicture}[background rectangle/.style={thick, draw=gray!60, fill=white, fill opacity=1.0, rounded corners=2px}, show background rectangle]
    ...
    \task [right=1.0cm of t6                              ] {t7} {}      {compare\\($t_7$)}    {0} {0}  {4}  {};
    ...
    \draw [bind]  (t5_so1) --++ (0.35,0) --++ (0.0,+1.2) --++ (3.175,0.0) |- (t7_si2);
    \draw [bind]  (t6_so1) --++ (0.5,0)                                   |- (t7_si1);
    \draw [bind]  (t2_so1) --++ (0.5,0) --++ (0.0,-2.5) --++ (8.8,0.0)    |- (t7_si3);

    \draw [bind, dashed]  (t4.south) --++ (0.0,-0.25) --++ (5.65,0.0)  -- (t6.south);

    \draw [bind]  (t4_so1) --++ (0.50,0) --++ (0.0,-0.55) --++ (6.2,0.0)  |- (t7_si4);
    \draw [bind]  (t7_so2) --++ (0.5,0)                                   |- (t8_si1);
    \draw [bind]  (t7_so4) --++ (0.5,0)                                   |- (t9_si1);
