...
template <typename T>
Relayer<T>
::Relayer(const size_t n_elmts, const size_t ns)
...
template <typename T>
void Relayer<T>
::relay(const T *in, T *out, const int frame_id, const bool managed_memory)
{
...
template <typename T>
void Relayer<T>
::_relay(const T *in, T *out, const size_t frame_id)
{
