...
template class aff3ct::module::Probe_throughput<int8_t>;
template class aff3ct::module::Probe_throughput<uint8_t>;
template class aff3ct::module::Probe_throughput<int16_t>;
template class aff3ct::module::Probe_throughput<uint16_t>;
template class aff3ct::module::Probe_throughput<int32_t>;
template class aff3ct::module::Probe_throughput<uint32_t>;
template class aff3ct::module::Probe_throughput<int64_t>;
template class aff3ct::module::Probe_throughput<uint64_t>;
template class aff3ct::module::Probe_throughput<float>;
template class aff3ct::module::Probe_throughput<double>;
// ==================================================================================== explicit template instantiation
