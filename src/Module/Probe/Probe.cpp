...
void AProbe
::proxy_register_probe(const size_t data_size, const std::type_index data_type, const std::string &unit,
...
void AProbe
::proxy_probe(const void *data, const size_t frame_id)
{
	this->check_reporter();
